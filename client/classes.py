...
class Bouton(Element):
    pressed = False
    def __init__(self, image1 , image2 , pos : pygame.Vector2 = pygame.Vector2(0, 0), condition = True):
...
class Texte(Element):
    def __init__(self, texte, x , y, couleur=(0, 0, 0), bg_color=None, taille=32, police = "client/assets/arial.ttf", condition = True):
        super().__init__(x,y,condition)
        self.texte = texte
